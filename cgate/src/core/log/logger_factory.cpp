...
namespace cgate
{
                                       ...
                                       const LogLevel level)
    {
        ...
        return * m_singleton->m_manager.add(key, new ConsoleLogger{level});
    } /* end of : ILogger &
                  LoggerFactory::createConsoleLogger(const std::string key,
                                                     const LogLevel level) */
                                    ...
                                    const LogLevel level)
    {
        ...
        return * m_singleton->m_manager.add(key, new FileLogger{path, do_clear, level});
    } /* end of : ILogger &
                  LoggerFactory::createFileLogger(const std::string key,
                                                  const std::string path,
                                                  const bool do_clear,
                          ...
                          ...)
    {
        ...
        for (auto it = m_singleton->m_manager.begin(), end = m_singleton->m_manager.end();
             it != end;
             ++it)
        {
            va_list vargs;
